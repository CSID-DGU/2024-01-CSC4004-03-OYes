    ...
    return (
        <div className="container-fluid d-flex flex-column" style={{height: '100vh'}}>
            <div className="d-flex flex-grow-1 mt-5 justify-content-center" style={{gap: '20px'}}>
                {logDisplay && (
                    <div className={`card shadow-sm w-25 transition-width`} style={{
                        height: logDisplay ? '100%' : '0',
                        maxHeight: logDisplay ? 'calc(100vh - 150px)' : '0',
                        overflow: 'hidden'
                    }}>
                ...
                <div className="card shadow-sm w-50 transition-width"
                     style={{height: '100%', maxHeight: 'calc(100vh - 150px)'}}>
                    <div className="card-body d-flex flex-column" style={{height: '100%'}}>
                        <div
                            className="border rounded flex-grow-1 mb-4 d-flex justify-content-center align-items-center"
                        ...
                        <div className="mb-3">
                            ...
                            <select id="model" name="model" className="form-select" value={model}
                        ...
                        <div className="d-flex justify-content-start align-items-center mb-3">
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <label className="switch">
                                    <input id="logDisplay" name="logDisplay" type="checkbox"
                                           onChange={toggleLogDisplay}/>
                                    <span className="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-3">
                            <p>RVC
                                - {rvcEnabled ? 'on: Corrects to sound similar to the selected RVC model\'s voice.' : 'off: Corrects to TTS voice.'}</p>
                            <p>show log - {logDisplay ? 'on: Shows logs.' : 'off: Does not show logs.'}</p>
                        </div>

                        <button className="btn btn-primary mt-auto" onClick={handleRecord}
                                style={{backgroundColor: recording ? '#FF7C80' : '#4E95D9', height: '50px'}}>
