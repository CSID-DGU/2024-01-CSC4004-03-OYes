...
def get_response(prompt):
    ...
    completions = openai.ChatCompletion.create(
          ...
          messages=[
                ...
                {"role": "assistant", "content": """몬하다는 못하다, 봉는다는 볶는다 처럼 사투리나 어색한 발음이 존재할 수 있어. 이런 걸 고쳐주면 돼."""},
...
for user_input in set_origin_script:
    get_corrected_script = cumulative_input(user_input, conversation_history, USERNAME, AI_NAME)     
